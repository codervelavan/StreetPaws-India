...
[![Open to Contributors](https://img.shields.io/badge/Contributors-Welcome-brightgreen.svg)](./CONTRIBUTING.md)
...
👉 **[View the live interactive prototype](./demo/index.html)** — open in any browser to see the full NGO dashboard, dog profiles, AI review queue, and mobile app simulation.
